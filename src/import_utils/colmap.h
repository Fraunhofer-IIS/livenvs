...
namespace colmap{
    ...
    Dataset load_dataset(const std::string& txt_dir, const std::string& img_dir, const std::string& depth_dir, const std::string& mesh_path, const std::string& color_file_ending, const std::string& depth_file_ending);
