...
void main() {
    ...
    this_frag.feat = debug_feat(vec4(0));// from_tex_array(feat_tex, tc);
    // this_frag.feat.feat0 = vec4(0,1,0,1); //from_tex_array(feat_tex, tc);
    // this_frag.feat.feat1 = vec4(0,1,0,1); //from_tex_array(feat_tex, tc);
    // this_frag.feat.feat2 = vec4(0,1,0,1); //from_tex_array(feat_tex, tc);
    // this_frag.feat.feat3 = vec4(0,1,0,1); //from_tex_array(feat_tex, tc);
